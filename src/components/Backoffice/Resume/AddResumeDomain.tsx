...
const AddResumeDomain = () => {
  ...
  const saveResume = (domain: number) => {
    ...
    fetch(`api/resume/${state.id}?domainId=${domain}`, options)
      .then((response) => {
...
export default AddResumeDomain;
