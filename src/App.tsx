...
const App = () => {
  ...
  return (
    <Router>
          ...
          <Routes>
            {maintenance ? (
              <>
                ...
                {isAdmin.isAdmin ? (
                  <Route
                    path="/addProjectTechnologyDomain"
                    element={<AddProjectTechnologyDomain />}
                  />
                ) : (
                  <Route path="/" element={<Placeholder />} />
                )}
                ...
                {isAdmin.isAdmin ? (
                  <Route
                    path="/addCertificateDomain"
                    element={<AddCertificateDomain />}
                  />
                ) : (
                  <Route path="/" element={<Placeholder />} />
                )}
                ...
                {isAdmin.isAdmin ? (
                  <Route path="/editTechnology" element={<EditTechnology />} />
                ) : (
                  <Route path="/" element={<Placeholder />} />
                )}
                {isAdmin.isAdmin ? (
                ...
                {isAdmin.isAdmin ? (
                  <Route
                    path="/addResumeDomain"
                    element={<AddResumeDomain />}
                  />
                ) : (
                  <Route path="/" element={<Placeholder />} />
                )}
                ...
                {isAdmin.isAdmin ? (
                  <Route path="/addBiography" element={<AddBiography />} />
                ) : (
                  <Route path="/" element={<Placeholder />} />
                )}
      ...
      {checking && 
          (
          <div className="d-flex justify-content-center" style={{backgroundColor: "var(--background-color)"}}>
            <Spinner
              animation="border"
